...
const PizzaBlock = ({
  ...
  const onClickToSetActiveType = (typeIndex) => {
    setActiveType(typeIndex);
  };
  const onClickToSetactiveSize = (typeIndex) => {
    setActiveSize(typeIndex);
  };
      ...
      <div className="pizza-block__selector">
        <ul>
          {aviableTypes.map((type, index) => (
            <li
              key={type}
              onClick={() => onClickToSetActiveType(index)}
        ...
        <ul>
          {aviableSizes.map((size, index) => (
            <li
              key={size}
              onClick={() => onClickToSetactiveSize(size)}
              className={classNames({
